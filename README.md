...
sendra/
  ...
  schema/          generated JSON Schemas for editor tooling — see JSON Schema / editor support
...
for the file shapes above, generated from `sendra-core`'s actual Rust types via
